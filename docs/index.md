...
See [Installation](getting-started/installation.md) for the release-line picker, prerequisites, and full setup, or jump to the [Tutorial](getting-started/tutorial.md) for a 5-minute walkthrough.
