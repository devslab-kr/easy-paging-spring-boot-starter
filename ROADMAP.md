...
This is the **Spring Boot 3 maintenance line.** Feature work happens on the SB4 active line (`4.x`); this `3.x` line gets security patches and dependency bumps for as long as Spring Boot 3 has upstream support. See the [main branch's ROADMAP](https://github.com/devslab-kr/easy-paging-spring-boot-starter/blob/main/ROADMAP.md) for SB4 feature plans.
