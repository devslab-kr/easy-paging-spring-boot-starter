...
> Spring Boot 3.3–3.5 사용 중이라면 [`3.x` maintenance 라인](https://github.com/devslab-kr/easy-paging-spring-boot-starter/tree/3.x)을 사용 (`kr.devslab:easy-paging-spring-boot-starter:3.0.0`). API 동일, SB3 BOM에 인증, 보안 패치 계속 제공. 라이브러리 메이저가 Spring Boot 메이저와 일치 — [버전 정책](https://github.com/devslab-kr/.github/blob/main/.github/VERSIONING.md#한국어) 참고.
